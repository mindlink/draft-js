...
var DraftEditor = function (_React$Component) {
  ...
  DraftEditor.prototype._restoreEditorDOM = function _restoreEditorDOM(scrollPosition) {
    ...
    var containerKey = !isAndroid ? this.state.containerKey + 1 : this.state.containerKey;
    var contentsKey = isAndroid ? this.state.contentsKey + 1 : this.state.contentsKey;
    this.setState({ containerKey: containerKey, contentsKey: contentsKey }, function () {
